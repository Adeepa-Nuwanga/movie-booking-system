...
<%
    List<BookingRequest> pendingRequests =
            (List<BookingRequest>) request.getAttribute("pendingRequests");

    List<BookingRequest> processedRequests =
            (List<BookingRequest>) request.getAttribute("processedRequests");

    BookingRequest lastProcessed =
            (BookingRequest) request.getAttribute("lastProcessed");

    Object queueSize = request.getAttribute("queueSize");

    if (queueSize == null) {
        queueSize = request.getAttribute("queueLength");
    }
%>
    ...
    <section class="admin-content">
        ...
        <div class="admin-header">
            ...
            <div class="queue-count">
                Queue Length <strong><%= queueSize %></strong>
            </div>
        </div>
        ...
        <div class="queue-grid">
            ...
            <section class="queue-panel">
                ...
                <div class="queue-item">
                    ...
                    <span>
                                <%= pending.getShowtimeId() %>
                                |
                                <%= String.join(", ", pending.getSelectedSeats()) %>
                            </span>
            ...
            <section class="queue-panel">
                ...
                <div class="queue-item">
                    ...
                    <span>
                            <%= lastProcessed.getShowtimeId() %>
                            |
                            <%= String.join(", ", lastProcessed.getSelectedSeats()) %>
                        </span>
