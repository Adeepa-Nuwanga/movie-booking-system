...
public class ShowtimeService {
    ...
    public synchronized List<Showtime> getShowtimesByMovieId(String movieId) {
    ...
    public synchronized Showtime getShowtimeById(String showtimeId) {
    ...
    public synchronized SeatMap getSeatMap(String showtimeId) {
    ...
    public synchronized String getMovieTitle(String movieId) {
